...
public class EVOFleetHomePage
{
    private static Logger logger = LogManager.getLogger(EVOFleetHomePage.class.getName());
  ...
  FW_WebDriverFunctions fw_WebDriverFunctions = new FW_WebDriverFunctions();
    ...
    private static final String LOCATOR_BELLICONBUTTON="/html/body/cnh-fleet[1]/tc-page-main[1]/div[1]/cnh-topbar[1]/div[1]/div[2]/cnh-action-icon[3]/div[1]/div[1]/div[1]";
    ...
    @FindBy(how=How.XPATH, using=LOCATOR_BELLICONBUTTON)
    private WebElement BellIconButton;
    ...
    //Modified the recorded function to capture runtime image of bell icon.
    public void captureBellIconButtonScreenshot(String pathWithFileName ){
        logger.info("[EVO : clickBellIconButton] Clicking 'BellIconButton' button");
        fw_WebDriverFunctions.waitForElementToAppear(By.xpath(LOCATOR_BELLICONBUTTON), "BellIconButton Button", FW_Const.SIXTY);
        fw_WebDriverFunctions.webElementScreenshot(BellIconButton, pathWithFileName);
