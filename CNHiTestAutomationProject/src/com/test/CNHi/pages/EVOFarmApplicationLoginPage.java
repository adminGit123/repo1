...
public class EVOFarmApplicationLoginPage
{
    private static Logger logger = LogManager.getLogger(EVOFarmApplicationLoginPage.class.getName());
    ...
    public void enterPasswordTextField(String textToBeEntered){
        logger.info("[EVOFleetApplicationLoginPage : enterPasswordTextField] Entering '" + textToBeEntered + "' in PasswordTextField");
